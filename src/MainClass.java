...
student Gokhan = new student("Gokhan Karasu"); //creating new object for student to add to the arraylist 
...
COIS3040H.append(Gokhan); // Appending object to the arraylist 
